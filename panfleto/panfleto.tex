...
\title{\bf Sigel Energy}

\author{%
\Large \bf Soluciones sustentables
%  Martin Schmoll\\
%  Predrag Puno\v{s}evac
}
\date{\bf Mantenimiento de paneles fotovoltaicos}
...
\AddToBackground{1}{%  Background of a small page
  \put(20,490){\includegraphics[scale=0.20]{logo.png}}}
...
\begin{center}
\includegraphics[scale=0.20]{panel.jpg}
\end{center}
...
\begin{center}
\includegraphics[scale=0.20]{estructura.jpg}
\end{center}
